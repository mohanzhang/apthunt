...
url = URI.join(ENV.fetch("BASE_URL"), '/floor-plans?unitrent_min=&unitrent_max=&bed_type%5B%5D=studio&bed_type%5B%5D=one&availability=0&floornumber_min=&floornumber_max=&wpv_filter_submit=Search')
